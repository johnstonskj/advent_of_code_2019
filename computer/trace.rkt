...
(require racket/bool racket/file racket/format racket/list racket/string racket/vector)
...
(define (trace-state pc state error-code)
  (when *trace-enabled*
    (display
     (format
      "/* ~a ~a ~a */  "
      (~a pc #:min-width 5 #:right-pad-string " ")
      (~a state #:min-width 8 #:right-pad-string " ")
      (~a error-code #:min-width 2 #:right-pad-string "0")))))
